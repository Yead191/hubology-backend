...
const increaseOrDecreseQuantity = catchAsync(async (req: Request, res: Response) => {
    const { id, amount } = req.body;
    await CartServices.increaseOrDecreseQuantity(id, amount);
...
const deleteProductFromCart = catchAsync(async (req: Request, res: Response,) => {
    const { id } = req.body;
