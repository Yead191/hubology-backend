          ...
          <tr>
            <td style="padding: 40px 40px 30px 40px;">
              ...
              <div style="background-color: #f9fafb; border: 1px solid #e5e7eb; border-radius: 8px; padding: 24px; text-align: center; margin-bottom: 24px;">
                ...
                <div style="background-color: #173616; color: #ffffff; border-bottom: 3px solid #bba15c; font-size: 30px; font-weight: 700; letter-spacing: 6px; padding: 12px 28px; display: inline-block; border-radius: 8px;">
                  ${values.otp}
                </div>
